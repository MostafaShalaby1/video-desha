...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("اوامر البوت..♥️", callback_data="cbcmds"),
                    InlineKeyboardButton("مبرمج البوت", url=f"https://t.me/{OWNER_NAME}"),
                ],
                [
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        "قناة السورس", url="https://t.me/music_Desha1"
                    )
                ],
            ]
        ),
