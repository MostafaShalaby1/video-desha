...
⋆ **[Mostafa Shalaby](https://t.me/DeshaXBlacck)**
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("طريقه التشغيل..🙂", callback_data="cbhowtouse")],
                [
                    InlineKeyboardButton("اوامر البوت", callback_data="cbcmds"),
                    InlineKeyboardButton("مبرمج البوت.♥️🙂", url=f"https://t.me/{OWNER_NAME}"),
                ],
                [
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        "قناة السورس", url="https://t.me/BANDA1M"
                    )
                ],
            ]
        ),
...
2.) **ثم قم بترقيتي كمسؤول ومنح جميع الأذونات باستثناء المسؤول المجهول.**
3.) **After promoting me, type /reload in group to refresh the admin data.**
3.) **ا @{ASSISTANT_NAME} to your group or type /userbotjoin to invite her.**
